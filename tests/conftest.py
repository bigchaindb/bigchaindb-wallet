...
def keymanagement_test_vectors():
    ...
    return SimpleNamespace(
        ...
        phrase=('inner clog tackle trip fire riot spice purpose inner permit '
        ...
        privkey=bytes.fromhex(
            '85e26d810b973fff21275125704dc485'
            '5d8245c428c9b28348bd3530690f3f57'),
        chaincode=bytes.fromhex(
            '31be3971e42d316d9b19c3e0ad9186db'
            '4ac62feb601b80703e1c8643d9bb4fed'),
        pubkey=bytes.fromhex(
            '00'
            'a341bde5863d9cf770599709fd582a89'
            'f65527b417abb890c9c964d0df4742ce'
        )
    )
...
def privkey_crypt_salt(keymanagement_test_vectors, default_password):
    ...
    from bigchaindb_wallet.keystore import symkey_encrypt
    crypt, salt = symkey_encrypt(
        keymanagement_test_vectors.privkey,
